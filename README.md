...
🌐 **Application en ligne :** [https://tresorier21000.github.io/geophoto-editor/](https://tresorier21000.github.io/geophoto-editor/)
...
*   **Modification :**
    ...
    *   **Recherche par lieu :** Entrez le nom d'une ville, d'un pays ou d'un lieu dans le monde entier dans la barre de recherche pour y placer un repère instantanément.
...
1.  **Ouvrir l'application :** Ouvrez simplement le fichier `index.html` dans votre navigateur web préféré (Chrome, Firefox, Safari, Edge).
...
*   **Sur GitHub Pages (Recommandé) :** Uploadez vos fichiers `index.html`, `style.css` et `script.js` sur un dépôt GitHub, puis activez les *GitHub Pages* dans les paramètres du dépôt. L'URL fournie par GitHub rendra votre application accessible sur n'importe quel appareil connecté à internet.
...
---
*Version 1.1 - Développé par Yves Balestra.*
